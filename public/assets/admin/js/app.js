...
function waitForMsg(){
  $.ajax({
    type: "GET",
    url: "admin/get_notification?count="+$('.navbar-notifi').length,
    async: true,
    cache: false,
    timeout:50000,
    ...
    success: function(data){
      if (data.status) {
          var audio = new Audio('https://crea8.indiepro.io/assets/admin/js/notification.mp3');
          audio.play();
          var msg = '<a href="https://crea8.indiepro.io'+data['notification'].click_url+'" class="dropdown-menu__item"><div class="navbar-notifi"><div class="navbar-notifi__left bg--green b-radius--rounded"><img src="https://crea8.indiepro.io/placeholder-image/590x300" alt=""></div><div class="navbar-notifi__right"><h6 class="notifi__title">'+data['notification'].title+'</h6><span class="time"><i class="far fa-clock"></i> now</span></div></div></a>';
          $('.dropdown-menu__body').prepend(msg);
      }
      setTimeout( waitForMsg
        ,1000);
    },
