...
@section('panel')
    ...
    <div id="addBulkCategoryModal" class="modal fade" tabindex="-1" role="dialog">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title">@lang('Add Bulk Category')</h5>
                ...
                <form action="{{ route('admin.category.bulk.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <label for="name" class="form-control-label font-weight-bold">@lang('CSV File')</label>

                            <input type="file" class="form-control form-control-lg" name="bulk" required="">
                            <small class="text-danger">@lang('Only CSV file is allowed')</small>
                        </div>
                    </div>
...
<!-- bulk upload -->
    <a href="javascript:void(0)" class="btn btn-sm btn--primary box--shadow1 text--small addBulkCategory" ><i class="las la-plus"></i>@lang('Add Bulk Category')</a>
...
@push('script')
    ...
    <script>
        ...
        $('.addBulkCategory').on('click', function() {

            $('#addBulkCategoryModal').modal('show');
