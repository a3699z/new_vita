                            ...
                            <tr @if($loop->odd) class="table-light" @endif>
                                ...
                                <td data-label="@lang('Featured Item')">
                                    @if($software->featured == 1)
                                        ...
                                        <a href="javascript:void(0)" class="icon-btn btn--info ml-2 notInclude" data-toggle="tooltip" title="" data-original-title="@lang('Not Include')" data-id="{{ $software->id }}">
                                            <i class="las la-arrow-alt-circle-left"></i>
                                        </a>
                                    @else
                                        <span class="badge badge-warning badge-pill font-weight-bold text-white">@lang('Not included')</span>
                                        <a href="javascript:void(0)" class="icon-btn btn--success ml-2 include text-white" data-toggle="tooltip" title="" data-original-title="@lang('Include')" data-id="{{ $software->id }}">
