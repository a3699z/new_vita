...
export interface RTCStatsArray extends RTCStatsInternal {
    find(predicate: (value: RTCStatsInternal, index: number, obj: RTCStatsInternal[]) => boolean, thisArg?: any): RTCStatsInternal | undefined;
    filter(predicate: (value: RTCStatsInternal, index: number, obj: RTCStatsInternal[]) => boolean, thisArg?: any): RTCStatsInternal[];
}
